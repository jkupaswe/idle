...
- Subprocess concern and output normalization live in two separate layers (`invokeClaudeP` / `normalizeClaudeOutput`) so the pure transforms are unit-testable without a subprocess mock.
